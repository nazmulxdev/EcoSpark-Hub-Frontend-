          ...
          {[1, 2, 3, 4, 5].map((i) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="h-6 w-8 bg-gray-200 dark:bg-zinc-800 rounded animate-pulse" />
              </div>
              <div className="h-3 w-12 bg-gray-200 dark:bg-zinc-800 rounded animate-pulse mt-2" />
            </div>
          ))}
        </div>
              ...
              <div className="flex flex-col lg:flex-row lg:items-start gap-4">
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-2 mb-3">
                    ...
                    <div className="h-5 w-24 bg-gray-200 dark:bg-zinc-800 rounded-full animate-pulse" />
                  </div>
