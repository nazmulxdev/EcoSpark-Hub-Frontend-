  ...
  return (
    <div className="w-full max-w-7xl mx-auto">
      ...
      >
        ...
        <div className="h-8 w-48 bg-gray-200 dark:bg-zinc-800 rounded-lg mx-auto mb-2 animate-pulse" />
        <div className="h-5 w-64 bg-gray-200 dark:bg-zinc-800 rounded-lg mx-auto animate-pulse" />
      </motion.div>
