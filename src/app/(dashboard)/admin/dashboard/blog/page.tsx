import { getAllBlogs } from "@/actions/client/blog.client";
import { BlogClient } from "@/components/modules/admin/blog/BlogClient";
import Link from "next/link";

export const metadata = {
  title: "Blog Management | Admin Dashboard",
  description: "Manage blog posts for EcoSpark Hub",
};
...
export default async function AdminBlogPage({ searchParams }: PageProps) {
  ...
  const result = await getAllBlogs(page, limit, searchTerm, isPublished);
